...
namespace SV20T1020109.DataLayers
{
    public interface IOrderDAL
    {
        ...
        /// </summary>     
        IList<Orders> List(int page = 1, int pageSize = 0,
                          int status = 0, DateTime? fromTime = null, DateTime? toTime = null,
                       string searchValue = "");
        /// <summary> 
        /// Đếm số lượng đơn hàng thỏa điều kiện tìm kiếm     /// </summary> 
        ...
        /// </summary> 
        IList<OrderDetails> ListDetails(int orderID);
        /// <summary> 
        /// Lấy thông tin của 1 mặt hàng được bán trong đơn hàng (1 chi tiết trong đơn hàng)     /// </summary>     
        OrderDetails? GetDetail(int orderID, int productID);
        /// <summary> 
